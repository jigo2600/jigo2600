...
static uint32_t ntsc_palette[] = {
    C(000000), C(404040), C(6C6C6C), C(909090), C(B0B0B0), C(C8C8C8), C(DCDCDC),
    C(ECECEC), C(444400), C(646410), C(848424), C(A0A034), C(B8B840), C(D0D050),
    C(E8E85C), C(FCFC68), C(702800), C(844414), C(985C28), C(AC783C), C(BC8C4C),
    C(CCA05C), C(DCB468), C(ECC878), C(841800), C(983418), C(AC5030), C(C06848),
    C(D0805C), C(E09470), C(ECA880), C(FCBC94), C(880000), C(9C2020), C(B03C3C),
    C(C05858), C(D07070), C(E08888), C(ECA0A0), C(FCB4B4), C(78005C), C(8C2074),
    C(A03C88), C(B0589C), C(C070B0), C(D084C0), C(DC9CD0), C(ECB0E0), C(480078),
    C(602090), C(783CA4), C(8C58B8), C(A070CC), C(B484DC), C(C49CEC), C(D4B0FC),
    C(140084), C(302098), C(4C3CAC), C(6858C0), C(7C70D0), C(9488E0), C(A8A0EC),
    C(BCB4FC), C(000088), C(1C209C), C(3840B0), C(505CC0), C(6874D0), C(7C8CE0),
    C(90A4EC), C(A4B8FC), C(00187C), C(1C3890), C(3854A8), C(5070BC), C(6888CC),
    C(7C9CDC), C(90B4EC), C(A4C8FC), C(002C5C), C(1C4C78), C(386890), C(5084AC),
    C(689CC0), C(7CB4D4), C(90CCE8), C(A4E0FC), C(003C2C), C(1C5C48), C(387C64),
    C(509C80), C(68B494), C(7CD0AC), C(90E4C0), C(A4FCD4), C(003C00), C(205C20),
    C(407C40), C(5C9C5C), C(74B474), C(8CD08C), C(A4E4A4), C(B8FCB8), C(143800),
    C(345C1C), C(507C38), C(6C9850), C(84B468), C(9CCC7C), C(B4E490), C(C8FCA4),
    C(2C3000), C(4C501C), C(687034), C(848C4C), C(9CA864), C(B4C078), C(CCD488),
    C(E0EC9C), C(442800), C(644818), C(846830), C(A08444), C(B89C58), C(D0B46C),
    C(E8CC7C), C(FCE08C),
};

static uint32_t pal_palette[] = {
    C(000000), C(282828), C(505050), C(747474), C(949494), C(B4B4B4), C(D0D0D0),
    C(ECECEC), C(000000), C(282828), C(505050), C(747474), C(949494), C(B4B4B4),
    C(D0D0D0), C(ECECEC), C(805800), C(947020), C(A8843C), C(BC9C58), C(CCAC70),
    C(DCC084), C(ECD09C), C(FCE0B0), C(445C00), C(5C7820), C(74903C), C(8CAC58),
    C(A0C070), C(B0D484), C(C4E89C), C(D4FCB0), C(703400), C(885020), C(A0683C),
    C(B48458), C(C89870), C(DCAC84), C(ECC09C), C(FCD4B0), C(006414), C(208034),
    C(3C9850), C(58B06C), C(70C484), C(84D89C), C(9CE8B4), C(B0FCC8), C(700014),
    C(882034), C(A03C50), C(B4586C), C(C87084), C(DC849C), C(EC9CB4), C(FCB0C8),
    C(005C5C), C(207474), C(3C8C8C), C(58A4A4), C(70B8B8), C(84C8C8), C(9CDCDC),
    C(B0ECEC), C(70005C), C(842074), C(943C88), C(A8589C), C(B470B0), C(C484C0),
    C(D09CD0), C(E0B0E0), C(003C70), C(1C5888), C(3874A0), C(508CB4), C(68A4C8),
    C(7CB8DC), C(90CCEC), C(A4E0FC), C(580070), C(6C2088), C(803CA0), C(9458B4),
    C(A470C8), C(B484DC), C(C49CEC), C(D4B0FC), C(002070), C(1C3C88), C(3858A0),
    C(5074B4), C(6888C8), C(7CA0DC), C(90B4EC), C(A4C8FC), C(3C0080), C(542094),
    C(6C3CA8), C(8058BC), C(9470CC), C(A884DC), C(B89CEC), C(C8B0FC), C(000088),
    C(20209C), C(3C3CB0), C(5858C0), C(7070D0), C(8484E0), C(9C9CEC), C(B0B0FC),
    C(000000), C(282828), C(505050), C(747474), C(949494), C(B4B4B4), C(D0D0D0),
    C(ECECEC), C(000000), C(282828), C(505050), C(747474), C(949494), C(B4B4B4),
    C(D0D0D0), C(ECECEC),
};
...
static uint32_t secam_palette[] = {
    C(000000), C(2121FF), C(F03C79), C(FF50FF), C(7FFF00), C(7FFFFF), C(FFFF3F),
    C(FFFFFF), C(000000), C(2121FF), C(F03C79), C(FF50FF), C(7FFF00), C(7FFFFF),
    C(FFFF3F), C(FFFFFF), C(000000), C(2121FF), C(F03C79), C(FF50FF), C(7FFF00),
    C(7FFFFF), C(FFFF3F), C(FFFFFF), C(000000), C(2121FF), C(F03C79), C(FF50FF),
    C(7FFF00), C(7FFFFF), C(FFFF3F), C(FFFFFF), C(000000), C(2121FF), C(F03C79),
    C(FF50FF), C(7FFF00), C(7FFFFF), C(FFFF3F), C(FFFFFF), C(000000), C(2121FF),
    C(F03C79), C(FF50FF), C(7FFF00), C(7FFFFF), C(FFFF3F), C(FFFFFF), C(000000),
    C(2121FF), C(F03C79), C(FF50FF), C(7FFF00), C(7FFFFF), C(FFFF3F), C(FFFFFF),
    C(000000), C(2121FF), C(F03C79), C(FF50FF), C(7FFF00), C(7FFFFF), C(FFFF3F),
    C(FFFFFF), C(000000), C(2121FF), C(F03C79), C(FF50FF), C(7FFF00), C(7FFFFF),
    C(FFFF3F), C(FFFFFF), C(000000), C(2121FF), C(F03C79), C(FF50FF), C(7FFF00),
    C(7FFFFF), C(FFFF3F), C(FFFFFF), C(000000), C(2121FF), C(F03C79), C(FF50FF),
...
static map<TIA::Register, char const*> tiaRegisterNames{
    N(VSYNC),  N(VBLANK), N(WSYNC),  N(RSYNC),  N(NUSIZ0), N(NUSIZ1), N(COLUP0),
    N(COLUP1), N(COLUPF), N(COLUBK), N(CTRLPF), N(REFP0),  N(REFP1),  N(PF0),
    N(PF1),    N(PF2),    N(RESP0),  N(RESP1),  N(RESM0),  N(RESM1),  N(RESBL),
    N(AUDC0),  N(AUDC1),  N(AUDF0),  N(AUDF1),  N(AUDV0),  N(AUDV1),  N(GRP0),
    N(GRP1),   N(ENAM0),  N(ENAM1),  N(ENABL),  N(HMP0),   N(HMP1),   N(HMM0),
    N(HMM1),   N(HMBL),   N(VDELP0), N(VDELP1), N(VDELBL), N(RESMP0), N(RESMP1),
    N(HMOVE),  N(HMCLR),  N(CXCLR),  N(CXM0P),  N(CXM1P),  N(CXP0FB), N(CXP1FB),
    N(CXM0FB), N(CXM1FB), N(CXBLPF), N(CXPPMM), N(INPT0),  N(INPT1),  N(INPT2),
    N(INPT3),  N(INPT4),  N(INPT5),  N(NA1),    N(NA2),
};
#undef N
...
TIAPlayerFast::Tables TIAPlayerFast::tables;
TIAMissileFast::Tables TIAMissileFast::tables;
...
TIA::Tables::Tables() {
  ...
  for (int v = 0; v < 64; ++v) {
    ...
    // Collision mask.
    unsigned int collision = (m0 && p0) * (1 << 8) |  // CXM0P
                             (m0 && p1) * (1 << 9) |  // .
                             (m1 && p1) * (1 << 10) | // CXM1P
                             (m1 && p0) * (1 << 11) | // .
                             (p0 && bl) * (1 << 12) | // CXP0FB
    ...
    // PF priority (0: no, 1: yes)
    for (int p = 0; p < 2; ++p) {
      // PF score mode (0: none, 1: left, 2: right)
      for (int s = 0; s < 3; ++s) {
...
inline uint32_t TIA::getColor(uint8_t value) const {
  ...
  default: return secam_palette[offset];
  }
}
...
void TIA::cycle(bool CS, bool Rw, uint16_t address, uint8_t& data) {
  for (int cycle = 0; cycle < 3; ++cycle) {
    ...
    // Advance (or potentially reset) the horizontal dual phase clock and
    // counter.
    ...
    // SHB is actually the same as the Hphasec RES signal.
    auto const SHB = Hphasec.getRES();

    // RHS_delayed = TIADelay(RHS)
    // HS = TIADualPhaseLatch(Hphasec, SHS, RHS_delayed)
    if (SHB && Hphasec.getPhi2()) {
      beamX = 0;
      ++beamY;
    } // <= revisit

    // HM logic
    // There should be a dual-phase delay between SEC and HMC switching to one.
    // We optimize this out by updating HMC *before* SEC is udpdated (instead as
    // after as we do for the rest of the dependency chains in level-sensitive
    // logic).
    ...
    // SEC and SECL logic
    // The SECL latch is set on SEC and reset on SHB. Corner case: it is
    // possible to hit HMOVE in such a way to cause SHB and SEC to turn on
    // exactly at the same time at the beginning of a line (colour clocks
    // 0,1,2,3). This is a race condition and SEC appears to prevail. Inverting
    // the following lines causes the `Bermuda' game to glitch.
    SEC.cycle(Hphasec, strobe == HMOVE);
    SECL &= !SHB;
    SECL |= SEC.get();

    // Extra clocks logic
    // This logic updates the enable signals for the extra clocks, not the clock
    // signal directly.
    ...
    visibility[TIAObject::PF] = PF.get();
    ...
    if (!VB) {
      ...
      // and after thant blank for 37 more. Howevder, several games blank for
      // less, so we make a consevative choice here and cut out only 30 lines
      // after VSYNC ends.
      int x = beamX - 68;
      int y = beamY - topMargin;
      bool right = (x >= 80);

      // Collisions and color.p
      // Collisions are deteced during HBLANK, but not during VBLANK.
      int collisionAndColor =
          tables.collisionAndColorTable[64 * 3 * PF.getPFP() +
    ...
    // to account for the RESMP depenency.
  ...
  // Update registers.
  // -----------------------------------------------------------------
  // When the CPU writes to the TIA, the whole cycle (corresponding to the 3
  // color cycles just performed) is used to update the internal data and
  // address buffers. These become available only at the *next* TIA cycle, which
  // is when the strobe is finally raised. We thus set it here for the next
  // cycle. Likewise, we immediately update the required registers, so they are
  // ready for the next iteration. However, empirically, there are a few
  // registers that must be updated one CLK cycle later, maybe due to internal
  // delays in the TIA; why this is so is unclear.
  //
  // In a read operation, the data written on the bus is the one available in
  // the third TIA cycle.

  if (CS) {
    auto reg = decodeAddress(Rw, address);
    if (Rw) {
      // The CPU reads from TIA. The TIA drives only a few bits (the last one or
      // last two) on the data bus, so the other are likely to stay the same as
      // they are due to capacitive effects.
      auto set2 = [&](uint8_t x) { data = (x & 0xc0) | (data & 0x3f); };
      // It seems that the TIA always sets the last two bits, defaulting to zero
      // for those registers that set only one (or the NA1, NA2 unutilized
      // addresses that set none).
      ...
      case NA1:
      case NA2:
        data = 0; /* todo: should be set2(0), but other emu get this wrong? */
        break;
      default: break;
      }
    } else {
      ...
      case ENAM0:
      case ENAM1: M[strobe - ENAM0].setENAM(D); break;
      case ENABL: B.setBLEN(D); break;
      case REFP0:
      case REFP1: P[strobe - REFP0].setREFL(D); break;
      case VDELP0:
      case VDELP1: P[strobe - VDELP0].setVDELP(D); break;
      case VDELBL: B.setBLVD(data); break;
      case RESMP0:
      case RESMP1: M[strobe - RESMP0].setRESMP(D); break;
      // case HMOVE: HMOVEL = true ; break ;
      case HMCLR: {
        BEC.clearHM();
        PEC[0].clearHM();
...
void jigo::to_json(nlohmann::json& j, const TIAState::VideoStandard& p) {
  switch (p) {
...
void jigo::from_json(const nlohmann::json& j, TIAState::VideoStandard& p) {
  if (j.is_null()) {
    ...
    if (str == "NTSC") {
      p = TIA::VideoStandard::NTSC;
    } else if (str == "PAL") {
      p = TIA::VideoStandard::PAL;
    } else if (str == "SECAM") {
      p = TIA::VideoStandard::SECAM;
    } else {
      throw std::invalid_argument(
...
void jigo::to_json(nlohmann::json& j, TIAState const& state) {
...
/// Throws `nlohmann::json::exception` on parsing errors.
void jigo::from_json(nlohmann::json const& j, TIAState& state) {
